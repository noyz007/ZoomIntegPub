var testTool = {
  ...
  getMeetingConfig: function () {
     console.log("-------------------------------------");
     console.log("mn:" + document.getElementById("meeting_number").value);
     console.log("name:" + document.getElementById("display_name").value);
     console.log("pwd:" + document.getElementById("meeting_pwd").value);
     console.log("role:" + parseInt(document.getElementById("meeting_role").value,10));
     console.log("email:" +  document.getElementById("meeting_email").value);
     console.log("lang:" + document.getElementById("meeting_lang").value);
     console.log("china:" + document.getElementById("meeting_china").value);
     console.log("-------------------------------------");
